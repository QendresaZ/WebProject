...
if(isset($_POST['submit'])){
    ...
    $sql = 'INSERT INTO services (title, description, photo) VALUES (:title, :description, :photo)';
...
<div class="mt-2">
    ...
    <?php endif; ?>
        <form name="add-service" action="add_services.php" method="post" enctype="multipart/form-data">
...
<script src="https://cdn.jsdelivr.net/jquery.validation/1.16.0/additional-methods.min.js"></script>
	<script src="../../js/add-service-validation.js"></script>